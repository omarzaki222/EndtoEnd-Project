// Jenkins Pipeline using Kaniko for Docker builds in Kubernetes
// This is an alternative to using Docker directly in Jenkins
            ...
            steps {
                script {
                    ...
                    sh """
                        ...
                        cat > kaniko-build.sh << 'EOF'
#!/bin/bash
set -e

# Create Docker config for authentication
mkdir -p /kaniko/.docker
cat > /kaniko/.docker/config.json << 'DOCKER_CONFIG'
{
  "auths": {
